...
class TestJsonServices(TestCase):
    def setUp(self):
        self.admin_user = User(user_id="Marta.Boss",
                               email="marta@mail.com", role="admin")
    ...
    def test_load_json_file(self):
        ...
        self.assertIsInstance(
            result, list, msg="The loaded JSON data from load_json_file() should be a list.")

    def test_write_json_data(self):
        self.data_to_write = [{"key": "value"}, {"number": 123}]
        self.saved_data = self.json_services.write_json_data(
            self.data_to_write)
        self.assertTrue(
    ...
    def test_append_data_to_file(self):
        ...
        self.adding_data = self.json_services.append_data_to_file(
            self.data_to_append)
        self.assertTrue(
            self.adding_data, msg="New record data should be saved in JSON file successfully.")
    ...
    def test_validate_data_against_schema(self):
        ...
        self.assertTrue(self.data_validation,
    ...
    def test_get_or_create_backup_dir(self):
        ...
        self.assertEqual(backup_dir, Path(config.BACKUP_FILES_DIRECTORY),
    ...
    def test_remove_from_file(self):
        ...
        key_value = "testvalue"
        self.assertTrue(self.json_services.remove_from_file(
            key_to_remove, key_value), msg="Records matching the given key should be removed from the JSON file and return True if any records were removed, otherwise False.")
    ...
    def test_update_data_in_file(self):
        ...
        self.assertTrue(self.json_services.update_data_in_file(key_to_update, new_data),
